...
@Table(
        ...
        indexes = {
                @Index(name = "idx_branch_addresses_branch_id", columnList = "branch_id"),
                @Index(name = "idx_branch_addresses_type", columnList = "address_type"),
                @Index(name = "idx_branch_addresses_is_primary", columnList = "is_primary"),
                @Index(name = "idx_branch_addresses_created_by", columnList = "created_by"),
                @Index(name = "idx_branch_addresses_updated_by", columnList = "updated_by"),
                @Index(name = "idx_branch_addresses_deleted_at", columnList = "deleted_at")
        }
)
@Check(constraints = """
...
public class BranchAddress extends AbstractAuditedSoftDeleteEntity {
    ...
    @JoinColumn(
            ...
            foreignKey = @ForeignKey(name = "fk_branch_addresses_branch")
    )
